          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="w-full md:w-2/3">
              <p className="text-lg text-gray-300 mb-4">
                ...
                web and mobile development. With a strong foundation in modern
                technologies and programming languages, I create responsive and
                user-friendly applications.
              </p>

              <p className="text-lg text-gray-300 mb-4">
                My journey in software development started with a curiosity
                about how digital products are built, which evolved into a deep
                passion for creating intuitive and efficient solutions.
              </p>

              <p className="text-lg text-gray-300">
                I'm constantly learning and exploring new technologies to stay
                at the forefront of innovation in the field of software
                engineering, with recent interests in AI and its applications.
              </p>
            </div>
          </div>
        </div>
